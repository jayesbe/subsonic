...
<c:set var="categories" value="${param.restricted ? 'personal password player share' : 'musicFolder general advanced personal user player network podcast share dlna sonos transcoding internetRadio audioAd'}"/>
<h1>
